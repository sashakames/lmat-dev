...
%\setlength{\itemindent{15pt}}
   ...
   \\
    In somewhat simplistic 
     ...
     Our current ``Full'' database (not yet available) is 372 GB in
...
\begin{verbatim}
   ...
   #  Download the marker libary, set <db-name> to kML.18mer.16bit (larger)
...
Check http://computation-dev.llnl.gov/lmat/example.php for additional example information.
